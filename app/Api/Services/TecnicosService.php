 ...
 * Tecnicos Service.
 */
class TecnicosService extends BaseService {

	// dependencies for delete.
    protected $dependencies = [];

    // entity table name
    protected $table_name = 'tecnico';
    ...
    public function getAll() {
        ...
        $qb
            ->select(
                ...
                'c.Pais', 'c.email', 'c.telefono', 'c.tipo_persona_juridica', 'c.representante')
            ->from('contacto', 'c')
    ...
    public function getById($id) {
        ...
        $qb
            ->select(
                ...
                'a.obra_id', 'a.cargo', 'a.intervencion')
     ...
     * Save Tecnico.
     */
    public function save($tecnico) {
        $this->db->insert($this->table_name, $tecnico);
        return $this->db->lastInsertId();
    }


    /**
     * Delete Tecnico by user id.
     */
